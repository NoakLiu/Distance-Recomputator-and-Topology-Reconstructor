...
class APPNP_Layer(nn.Module):
    def __init__(self, in_features, out_features, alpha, adj, iterations, dropout, device, model_mode="APPNP"):
        ...
        # The adjacency matrix remains fixed in the APPNP layer.
        self.adj = adj
...
class APPNP(nn.Module):
    ...
    def forward(self, x):
        # Apply dropout and then APPNP layers
